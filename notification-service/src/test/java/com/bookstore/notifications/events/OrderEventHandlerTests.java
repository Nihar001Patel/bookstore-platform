...
import com.bookstore.notifications.AbstractIT;
import com.bookstore.notifications.ApplicationProperties;
import com.bookstore.notifications.domain.models.Address;
import com.bookstore.notifications.domain.models.Customer;
...
class OrderEventHandlerTests extends AbstractIT {
    ...
    Customer customer = new Customer("Demo User", "demo.user@example.com", "999999999");
